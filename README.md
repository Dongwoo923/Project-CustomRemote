...
IR 송·수신 센서를 활용하여 여러 기기의 리모컨 기능을 하나의 디바이스로 통합한 **만능 커스텀 리모컨 프로젝트**입니다. 기존 리모컨의 IR 신호를 수신하고, 이를 저장한 뒤 필요 시 송신하는 구조로 설계되었습니다.

![메인 화면](images/메인화면.jpg)
---
